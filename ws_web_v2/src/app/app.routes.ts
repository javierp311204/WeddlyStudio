...
export const routes: Routes = [
  ...
  // ── Rutas autenticadas — solo necesitan token ───────────────
  ...
  // ── Visibles para cualquier miembro de la boda (guest+) ────
  { path: 'album',      component: AlbumDigitalComponent,  canActivate: [authGuard, minRoleGuard('guest')] },
  { path: 'checklist',  component: ChecklistBodaComponent, canActivate: [authGuard, minRoleGuard('guest')] },
  { path: 'info-boda',  component: InfoBodaComponent,      canActivate: [authGuard, minRoleGuard('guest')] },

  // ── Planner o superior ─────────────────────────────────────
  { path: 'invitados',  component: ListaInvitadosComponent,   canActivate: [authGuard, minRoleGuard('planner')] },
  {
    path: 'mesas',
  ...
  { path: 'diseno',         component: DisenoPapeleriaComponent, canActivate: [authGuard, minRoleGuard('co_organizer')] },
  { path: 'colaboradores',  component: ColaboradoresComponent,   canActivate: [authGuard, minRoleGuard('co_organizer')] },
